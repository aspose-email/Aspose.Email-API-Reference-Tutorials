...
2.  Überprüfen Sie, ob es sich bei der E-Mail um eine TNEF-Nachricht handelt`IsTnefMessage()`.
3.  Wenn es sich um eine TNEF-Nachricht handelt, extrahieren Sie Anhänge mit`ExtractTnefAttachments()`.
