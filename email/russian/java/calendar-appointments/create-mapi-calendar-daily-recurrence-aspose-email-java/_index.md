...
1. **Могу ли я использовать Aspose.Email без лицензии?**  
   - Да, вы можете начать с бесплатной пробной версии, чтобы изучить её возможности.  
2. **Как обрабатывать исключения в повторяющихся событиях?**  
   - Используйте `MapiCalendarExceptionInfo` для определения даты, изменённых времён и любых вложенных данных.  
3. **Можно ли сохранять календари напрямую в PST‑файлы?**  
   - Безусловно. Класс `PersonalStorage` позволяет создавать PST‑файлы и добавлять в них элементы календаря.  
4. **Можно ли интегрировать это с другими Java‑приложениями?**  
   - Да, API полностью на Java, поэтому его можно внедрять в любой сервис или настольное приложение на Java.  
5. **Что делать, если моя лицензия истекла?**  
   - Продлите лицензию через портал Aspose или временно переключитесь обратно в пробный режим.
