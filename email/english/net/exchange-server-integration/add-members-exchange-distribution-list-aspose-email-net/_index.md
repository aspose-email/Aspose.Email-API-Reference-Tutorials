...
date: "2025-05-29"
weight: 1
url: "/net/exchange-server-integration/add-members-exchange-distribution-list-aspose-email-net/"
keywords:
- Aspose.Email
- Net
- Document Processing
...
- **Libraries**: Aspose.Email for .NET version 21.11 or later.
- **Environment**: A development setup supporting .NET applications (e.g., Visual Studio).
- **Knowledge**: Basic understanding of C# and REST APIs.
...
You can start with a [free trial](https://releases.aspose.com/email/net/) to explore features. For extended use, consider obtaining a temporary or full license:

1. **Free Trial**: Download and apply a free trial license from Aspose's website.
2. **Temporary License**: Request a [temporary license](https://purchase.aspose.com/temporary-license/) for evaluation purposes.
3. **Purchase**: Unlock all features by purchasing a full license if satisfied.
