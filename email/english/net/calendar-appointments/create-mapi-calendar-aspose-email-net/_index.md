...
date: "2025-05-30"
weight: 1
url: "/net/calendar-appointments/create-mapi-calendar-aspose-email-net/"
keywords:
- Aspose.Email
- Net
- Document Processing
...
Alternatively, use the **NuGet Package Manager UI** by searching for "Aspose.Email" and installing it.

### License Acquisition

You can obtain a free trial to test Aspose.Email features. For more extensive testing or production usage:
- Request a [temporary license](https://purchase.aspose.com/temporary-license/).
- Consider purchasing a full license if you find the library meets your needs ([Purchase Here](https://purchase.aspose.com/buy)).
