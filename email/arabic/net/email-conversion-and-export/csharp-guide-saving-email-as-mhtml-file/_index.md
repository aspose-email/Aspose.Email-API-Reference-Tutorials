...
1. Download the library from [هنا](https://releases.aspose.com/email/net).
...
You can download the latest version of Aspose.Email for .NET from [هنا](https://releases.aspose.com/email/net).
