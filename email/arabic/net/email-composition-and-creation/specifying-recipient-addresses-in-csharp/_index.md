...
You can add recipient addresses using the `To`، `Cc`، و `Bcc` خصائص `MailMessage` class. Here's how you can add recipient addresses:
...
### How can I add multiple recipients to the `To`، `Cc`، أو `Bcc` fields?
