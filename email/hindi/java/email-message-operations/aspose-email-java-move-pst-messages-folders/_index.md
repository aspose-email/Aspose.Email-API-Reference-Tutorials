...
**ओवरव्यू**: PST फ़ाइल को इनिशियलाइज़ करना और उसके पहले से तय फ़ोल्डर जैसे इनबॉक्स और डिलीटेड आइटम को एक्सेस करना सीखें।

#### स्टेप 1: PST फ़ाइल लोड करें
```java
PersonalStorage pst = PersonalStorage.fromFile("YOUR_DOCUMENT_DIRECTORY/test.pst");
```

#### स्टेप 2: पहले से तय फ़ोल्डर एक्सेस करें
- **इनबॉक्स फ़ोल्डर**:  
    ```java
    FolderInfo inbox = pst.getPredefinedFolder(StandardIpmFolder.Inbox);
    ```
- **डिलीटेड आइटम फ़ोल्डर**:
    ```java
    FolderInfo deletedItems = pst.getPredefinedFolder(StandardIpmFolder.DeletedItems);
    ```

### PST में एक सबफ़ोल्डर को दूसरे फ़ोल्डर में स्थानांतरित करना
**ओवरव्यू**: PST फ़ाइल में एक फ़ोल्डर से दूसरे फ़ोल्डर में पूरा सबफ़ोल्डर ले जाएँ।

#### स्टेप 1: सोर्स और डेस्टिनेशन फ़ोल्डर एक्सेस करें
```java
FolderInfo inbox = pst.getPredefinedFolder(StandardIpmFolder.Inbox);
FolderInfo deletedItems = pst.getPredefinedFolder(StandardIpmFolder.DeletedItems);
```

#### स्टेप 2: इनबॉक्स से एक खास सबफ़ोल्डर लें
```java
FolderInfo subfolder = inbox.getSubFolder("Subfolder");
```

#### स्टेप 3: पूरा सबफ़ोल्डर ले जाएँ
```java
pst.moveItem(subfolder, deletedItems);
```

### PST में फ़ोल्डरों के बीच व्यक्तिगत संदेशों को स्थानांतरित करना
**ओवरव्यू**: सिंगल ईमेल मैसेज को एक फ़ोल्डर से दूसरे फ़ोल्डर में ले जाएँ।

#### स्टेप 1: किसी खास सबफ़ोल्डर से मैसेज पाएं
```java
FolderInfo subfolder = inbox.getSubFolder("Subfolder");
MessageInfoCollection contents = subfolder.getContents();
```

#### स्टेप 2: पहले मैसेज को डिलीटेड आइटम्स फ़ोल्डर में ले जाएं
```java
pst.moveItem(contents.get_Item(0), deletedItems);
```

### एक फ़ोल्डर से दूसरे फ़ोल्डर में सभी सबफ़ोल्डर स्थानांतरित करना
**ओवरव्यू**: हर सबफ़ोल्डर को सोर्स फ़ोल्डर (जैसे, इनबॉक्स) से डेस्टिनेशन फ़ोल्डर (जैसे, डिलीटेड आइटम्स) में ट्रांसफ़र करें।
...
#### स्टेप 2: सभी सबफ़ोल्डर मूव करें
```java
inbox.moveSubfolders(deletedItems);
```

### एक सबफ़ोल्डर की सभी सामग्री को दूसरे फ़ोल्डर में स्थानांतरित करना
**ओवरव्यू**: सबफ़ोल्डर के अंदर हर मैसेज को एक अलग फ़ोल्डर में रिलोकेट करें।
...
#### स्टेप 2: इनबॉक्स से कोई खास सबफ़ोल्डर पाएं
```java
FolderInfo subfolder = inbox.getSubFolder("Subfolder");
```

#### स्टेप 3: सबफ़ोल्डर का सारा कंटेंट मूव करें
```java
